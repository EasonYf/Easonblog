...
`)},S1=(e,t=!0)=>n=>(t&&t1(e),K(n,D,"2.0.0-beta.67"),n.env.isDebug&&p.info("Options:",e),I(n,{id:"hope"}),{name:D,define:x1(e,t),extendsBundlerOptions:(o,i)=>{e?.components?.includes("VidStack")&&G(o,i,/^media-/),J(o,i,"vuepress-shared")},clientConfigFile:o=>L1(o,e,t)});export{_ as backToTopLocales,S1 as componentsPlugin,O as pdfLocaleConfig,$ as siteInfoLocaleConfig};
